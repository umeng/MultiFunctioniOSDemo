 ...
 */
+ (void)registerForRemoteNotificationsWithLaunchOptions:(NSDictionary *_Nullable)launchOptions Entity:(UMessageRegisterEntity *_Nullable)entity completionHandler:(void (^_Nullable)(BOOL granted, NSError *__nullable error))completionHandler;
 ...
 */
+ (void)getTags:(void (^_Nonnull)(NSSet *__nonnull responseTags,NSInteger remain,NSError *__nonnull error))handle;
 ...
 */
+ (void)addTags:(__nonnull id)tag response:(nullable void (^)(id __nonnull responseObject ,NSInteger remain,NSError *__nonnull error))handle;
...
/** 删除设备中绑定的一个或多个tag
 ...
 @param handle responseTags为绑定的tag集合,remain剩余可用的tag数,为-1时表示异常,error为获取失败时的信息(ErrCode:kUMessageError)
 */
+ (void)deleteTags:(__nonnull id)tag response:(nullable void (^)(id __nonnull responseObject,NSInteger remain,NSError *__nonnull error))handle;
...
/**
 ...
 @param handle responseTags为绑定的tag集合,remain剩余可用的tag数,为-1时表示异常,error为获取失败时的信息(ErrCode:kUMessageError)
 */
+ (void)addWeightedTags:(NSDictionary * _Nonnull)weightedTag response:(nullable void (^)(id __nonnull responseObject ,NSInteger remain,NSError *__nonnull error))handle;
 ...
 */
+ (void)getWeightedTags:(void (^_Nonnull)(NSDictionary *__nonnull responseWeightedTags,NSInteger remain,NSError *__nonnull error))handle;
...
/**
 ...
 @param handle responseTags为绑定的tag集合,remain剩余可用的tag数,为-1时表示异常,error为获取失败时的信息(ErrCode:kUMessageError)
 */
+ (void)deleteWeightedTags:(id _Nonnull)weightedTags response:(nullable void (^)(id __nonnull responseObject,NSInteger remain,NSError *__nonnull error))handle;
